...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li class="topusername">您好欢迎来到京西！[<a href="<?php echo U('Member/login');?>">登录</a>] [<a href="<?php echo U('Member/regist');?>">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <div class="category fl <?php echo ($isNotHiddenMenu?'cat1':''); ?>"> <!-- 非首页，需要添加cat1类 -->
            <div class="cat_hd <?php echo ($isNotHiddenMenu?'off':''); ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
                <h2>全部商品分类</h2>
                <em></em>
            </div>

            <div class="cat_bd <?php echo ($isNotHiddenMenu?'none':''); ?> ">

                <?php if(is_array($goodscategorylist)): $i = 0; $__LIST__ = $goodscategorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodscategory1): $mod = ($i % 2 );++$i; if(($goodscategory1["level"]) == "1"): ?><div class="cat item1">
                    <h3><a href=""><?php echo ($goodscategory1["name"]); ?></a> <b></b></h3>
                    <div class="cat_detail">
                        <?php if(is_array($goodscategorylist)): $i = 0; $__LIST__ = $goodscategorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodscategory2): $mod = ($i % 2 );++$i; if(($goodscategory2["parent_id"]) == $goodscategory1["id"]): ?><dl class="dl_1st">
                            <dt><a href=""><?php echo ($goodscategory2["name"]); ?></a></dt>
                                <?php if(is_array($goodscategorylist)): $i = 0; $__LIST__ = $goodscategorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodscategory3): $mod = ($i % 2 );++$i; if(($goodscategory3["parent_id"]) == $goodscategory2["id"]): ?><dd>
                                            <a href=""><?php echo ($goodscategory3["name"]); ?></a>
...
<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<?php if(is_array($goodscategory)): $i = 0; $__LIST__ = $goodscategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?><a href=""><?php echo ($category['name']); ?></a> ><?php endforeach; endif; else: echo "" ;endif; ?> <?php echo ($name); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo PICTURE_URL; ?>Uploads/<?php echo ($logo); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img width="350px" height="350px" src="<?php echo PICTURE_URL; ?>Uploads/<?php echo ($logo); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo PICTURE_URL; ?>Uploads/<?php echo ($logo); ?>',largeimage: '<?php echo PICTURE_URL; ?>Uploads/<?php echo ($logo); ?>"><img src="<?php echo PICTURE_URL; ?>Uploads/<?php echo ($logo); ?>"></a>
								</li>
								<?php if(is_array($goodsgallery)): $i = 0; $__LIST__ = $goodsgallery;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$path): $mod = ($i % 2 );++$i;?><li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo PICTURE_URL; ?>Uploads/<?php echo ($path); ?>',largeimage: '<?php echo PICTURE_URL; ?>Uploads/<?php echo ($path); ?>'}"><img src="<?php echo PICTURE_URL; ?>Uploads/<?php echo ($path); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('ShoppingCar/add');?>" method="post" class="choose">
						<ul>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="http://www.shop.com//Public/Home/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://www.shop.com//Public/Home/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
...
<div class="bottomnav w1210 bc mt10">
    <?php if(is_array($articlecategoryList)): $j = 0; $__LIST__ = $articlecategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articlecategory): $mod = ($j % 2 );++$j;?><div class="bnav<?php echo ($j); ?>">
        <h3><b></b> <em><?php echo ($articlecategory['name']); ?></em></h3>
        <ul>
            <?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i; if(($article["article_category_id"]) == $articlecategory["id"]): ?><li><a href=""><?php echo ($article["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<script type="text/javascript">
    $(function(){
        $.getJSON("<?php echo U('getUserName');?>",'',function(data){
            if(data){
                $(".topusername").empty();
                html="您好"+data.username+"欢迎来到京西! [<a href='"+data.logouturl+"'>退出登录</a>]";
               $(".topusername").append(html);
            }
        })
    })
</script>
	...
	<script type="text/javascript">
		//发送ajax请求,将该商品的浏览次数增加一次
		var id=<?php echo ($id); ?>;
		$.get("<?php echo U('lookGoodsTimes');?>",{'goods_id':id},'');
	</script>
