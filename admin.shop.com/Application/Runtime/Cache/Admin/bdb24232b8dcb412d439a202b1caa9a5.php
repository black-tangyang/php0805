...
<div id="header-div">
    ...
    <div id="submenu-div">
        ...
        <div id="send_info">
            <a href="#" target="main-frame" class="fix-submenu"><?php echo ((isset($_SESSION['userinfo']['username']) && ($_SESSION['userinfo']['username'] !== ""))?($_SESSION['userinfo']['username']):''); ?></a>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="__GROUP__/User/userList" target="main-frame"><?php $userinfo=login(); echo $userinfo['username']; ?></a></li>
