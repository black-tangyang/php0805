    ...
    <div class="main-div">
        <form method="post" action="<?php echo U();?>" enctype="multipart/form-data">
            <table cellspacing="1" cellpadding="3" width="100%">
                ...
                </tr><tr><td class='label'>品牌LOGO</td>
                <td>
                    <input type='file' name='logo' maxlength='60' />
                </td>
                </tr><tr>
                ...
                </tr><tr><td class='label'>状态显示</td><td><input type='radio' name='status' class='box' value='1'/> 是<input type='radio' name='status' class='box' value='0'/> 否  </td></tr><tr>
