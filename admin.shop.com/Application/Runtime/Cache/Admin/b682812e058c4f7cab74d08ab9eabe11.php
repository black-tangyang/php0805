...
<th>排序</th>
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['add_time']); ?></span>
                    </td>
                                        
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['last_login_time']); ?></span>
                    </td>
                                        
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['salt']); ?></span>
                    </td>
                    ...
                    <td align="center">
                        ...
                        <a href="<?php echo U('resetPassword',array(id=>$row['id']));?>" class="ajax_get" title="重置密码">重置密码</a>
                    </td>
