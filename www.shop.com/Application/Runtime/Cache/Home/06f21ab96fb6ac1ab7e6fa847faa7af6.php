	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php if(is_array($shoppingCar)): $i = 0; $__LIST__ = $shoppingCar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
					<td class="col1"><a href=""><img src="<?php echo PICTURE_URL; ?>Uploads/<?php echo ($item['logo']); ?>" alt="" /></a>  <strong><a href="">【1111购物狂欢节】<?php echo ($item['name']); ?></a></strong></td>
					<td class="col2"></td>
					<td class="col3">￥<span><?php echo ($item['shop_price']); ?></span></td>
					<td class="col4"> 
