...
<th>排序</th>
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['sn']); ?></span>
                    </td>
                                        
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['goods_category_id']); ?></span>
                    </td>
                    ...
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['supplier_id']); ?></span>
                    </td>
                    ...
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['is_on_sale']); ?></span>
                    </td>
                                        
                    <td class="first-cell" align="center">
                        <span><?php echo ($row['goods_status']); ?></span>
                    </td>
